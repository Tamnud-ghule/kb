/**
 * MarketplaceFooter component - Footer for the data marketplace
 * Provides links, company information, and contact details
 */
import React from 'react';
import { Link } from 'wouter';

// Helper component to avoid nested Link + a tags
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { label: 'New Additions', href: '/new-datasets' },
        { label: 'Data Pricing', href: '/pricing' },
      ],
    },
    {
      title: 'Compliance',
      links: [
        ...
        { label: 'Compliance Documentation', href: '/documentation' },
      ],
    },
    {
      title: 'Company',
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="xl:grid xl:grid-cols-5 xl:gap-8">
          ...
          <div className="xl:col-span-1 space-y-8">
            <div>
              <span className="text-xl font-bold text-gray-900">DataSecure</span>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-400 text-center">
            &copy; {currentYear} DataSecure, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
